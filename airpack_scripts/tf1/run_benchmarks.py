...
def benchmark(onnx_file: Union[str, os.PathLike]) -> None:
    ...
    .. seealso::
        ...
        the :py:func:`airpack.tf1.model.default_network`. If non-default parameters are
        needed for your customization, it is better practice to call directly the
        :py:func:`airpack.deploy.trt.onnx2plan` and
        :py:func:`airpack.tf1.model.default_network` instead of this demonstration
        wrapper.
    ...
    if plan_file.exists():
        ...
        trt.onnx2plan(
            onnx_file,
            input_node_name='input/IteratorGetNext',
            input_port_name='',
            input_len=4096,
            fp16_mode=True,
...
if __name__ == "__main__":
    ...
    _onnx_file = _airpack_root / "output" / "tf1" / "saved_model.onnx"
