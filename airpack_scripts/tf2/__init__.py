...
"""Executable scripts for Tensorflow 2.x backend for AirPack.
...
if _tf_version < _parse_version('2.0.0'):
    raise ImportError(
        "airpack_scripts.tf2 requires at least Tensorflow 2.0.0, found version {}".format(
