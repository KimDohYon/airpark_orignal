...
"""Tensorflow 1.x backend for AirPack.
...
if _tf_version < _parse_version('1.14.0'):
    raise ImportError(
        "airpack.tf1 requires at least Tensorflow 1.14.0, found version {}".format(
            tensorflow.__version__))
elif _tf_version >= _parse_version('2.0.0'):
    raise ImportError(
        "airpack.tf1 requires Tensorflow 1.x, but found version {}".format(
            tensorflow.__version__))
